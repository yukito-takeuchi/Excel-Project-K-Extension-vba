Sub 三期連続比較表作成()
  ...
  If Worksheets("入力").Range("B31") >= 0 Then
  ...
  If Worksheets("入力").Range("k31") >= 0 Then
    Worksheets("②PL").Activate
    Rows("4").RowHeight = Cells(4, 75)
    Rows("5").RowHeight = Cells(5, 75)
    Rows("6").RowHeight = Cells(6, 75)
  ...
  If Worksheets("入力").Range("t31") >= 0 Then
    Worksheets("③PL").Activate
    Rows("4").RowHeight = Cells(4, 75)
    Rows("5").RowHeight = Cells(5, 75)
    Rows("6").RowHeight = Cells(6, 75)
  ...
  If Worksheets("入力").Range("b12") >= 0 Then
  ...
  If Worksheets("入力").Range("k12") >= 0 Then
    Worksheets("②BS").Activate
      Rows("4").RowHeight = Cells(4, 17)
      Rows("5").RowHeight = Cells(5, 17)
      Rows("6").RowHeight = Cells(6, 17)
  ...
  If Worksheets("入力").Range("t12") >= 0 Then
    Worksheets("③BS").Activate
      Rows("4").RowHeight = Cells(4, 17)
      Rows("5").RowHeight = Cells(5, 17)
      Rows("6").RowHeight = Cells(6, 17)
  ...
  Sheets("三期比較決算図表").Select
  Range("a70").Select
 
  MsgBox "必要に応じて比率ラベル等の位置を調整してください", vbInformation, "完成しました"
